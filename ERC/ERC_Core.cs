...
namespace ERC
{
    ...
    public class ERC_Core
    {
        ...
        public byte[] Generate_Byte_Array(byte[] unwantedBytes)
        {
            string byteFilename = Display_Output.Get_Module_File_Name(Working_Directory, "ByteArray_", ".dll");
            byte[] Byte_Array = Payloads.Get_Byte_Array(unwantedBytes);
